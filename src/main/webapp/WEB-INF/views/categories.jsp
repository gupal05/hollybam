    ...
    <div class="category-main-container">
        <section style="flex: 1; width: 100%;">
            ...
            <nav class="breadcrumb" aria-label="breadcrumb">
                ...
                <span class="current">리얼돌</span>
            </nav>
            <div style="display: flex;">
                <!-- 좌측 카테고리 -->
                <aside class="category-sidebar">
                    <div class="main-category-title">남성용품</div>
                    <ul class="sub-category-list">
                        <li class="sub-category-item">리얼돌</li> <!-- 선택된 카테고리에서는 이걸로 변경 class="sub-category-item active -->
                        <li class="sub-category-item">오나홀/핸드잡</li>
                        <li class="sub-category-item">엉덩이/가슴</li>
                        <li class="sub-category-item">전신/반신 인형</li>
                        <li class="sub-category-item">전자동 자위기구</li>
                        <li class="sub-category-item">텐가/홀컵/오나컵</li>
                        <li class="sub-category-item">남성 애널기구</li>
                        <li class="sub-category-item">사정지연/칙칙이</li>
                        <li class="sub-category-item">남성단련/정력링</li>
                        <li class="sub-category-item">섹스보조/러브링</li>
                        <li class="sub-category-item">여성흥분/진동링</li>
                        <li class="sub-category-item">남성강화/발기콘돔</li>
                        <li class="sub-category-item">음경확대/확장기</li>
                        <li class="sub-category-item">발기 건강식품</li>
                    </ul>
                </aside>
                <!-- 우측 상품 리스트 -->
                <section class="category-product-area">
                    <div class="product-list-header">
                        <span class="product-list-title">남성용품 - 리얼돌</span>
