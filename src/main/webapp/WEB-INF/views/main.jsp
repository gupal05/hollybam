...
<div class="category-section">
    <div class="category-container">
        <h2 class="category-title">인기상품</h2>
        ...
        <div class="product-row">
            <article class="v4-product">
                <a class="card-product-widget" href="#">
                    ...
                    <div class="card-product-img">
                        <img src="${pageContext.request.contextPath}/images/홀리밤 피스톤 머시 (10종 구성).webp" alt="상품 이미지"/>
                    </div>
            ...
            <article class="v4-product">
                <a class="card-product-widget" href="#">
                    ...
                    <div class="card-product-img">
                        <img src="${pageContext.request.contextPath}/images/홀 래빗 진동 흡입기.webp" alt="상품 이미지"/>
                    </div>
                    <div class="card-product-info">
            ...
            <article class="v4-product">
                <a class="card-product-widget" href="#">
                    <div class="card-product-img">
                        <img src="${pageContext.request.contextPath}/images/홀리밤 페어리 딜도.webp" alt="상품 이미지"/>
                    </div>
                    <div class="card-product-info">
